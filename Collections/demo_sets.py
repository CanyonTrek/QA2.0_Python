...
def main():
    ...
    print(f"Set of Brave Knights or Lumber Jacks = {brave_knights.union(lumber_jacks)}")
    print(f"Set of Brave Knights AND Lumber Jacks = {brave_knights.intersection(lumber_jacks)}")
    print(f"Strictly Brave Knights ONLY = {brave_knights.difference(lumber_jacks)}")
    print(f"Strictly ONLY Brave Knights OR Lumber Jacks = {brave_knights.symmetric_difference(lumber_jacks)}")
    print("-" * 60)
